...
<head>
    <meta charset="utf-8">
    <title>{{ isset($dataJenisSurat) ? 'Edit Jenis Surat - Bina Desa' : 'Tambah Jenis Surat - Bina Desa' }}</title>
...
<body>
    ...
    <div class="page-header">
        <div class="container text-center">
            <h1 class="display-4 text-white mb-3 animate__animated animate__fadeInDown">{{ isset($dataJenisSurat) ? 'Edit Jenis Surat' : 'Tambah Jenis Surat' }}</h1>
            <p class="lead text-white animate__animated animate__fadeInUp">{{ isset($dataJenisSurat) ? 'Perbarui informasi jenis surat' : 'Tambahkan jenis surat baru ke sistem' }}</p>
        </div>
    </div>
    <!-- Page Header End -->
                    ...
                    <div class="card form-card animate__animated animate__fadeInUp">
                        <div class="form-header text-center">
                            <h3 class="mb-0">
                                ...
                                {{ isset($dataJenisSurat) ? 'Edit Jenis Surat' : 'Formulir Jenis Surat Baru' }}
                            </h3>
                        </div>
                        <div class="form-body">
                            <form method="POST" action="{{ isset($dataJenisSurat) ? route('jenis-surat.update', $dataJenisSurat->jenis_id) : route('jenis-surat.store') }}">
                                @csrf
                                ...
                                <div class="d-flex justify-content-between align-items-center mt-5">
                                    ...
                                    <button type="submit" class="btn btn-primary btn-submit">
                                        <i class="fas fa-save me-2"></i>{{ isset($dataJenisSurat) ? 'Perbarui' : 'Simpan' }}
                                    </button>
                                </div>
                            </form>
                        </div>
