...
<head>
    <meta charset="utf-8">
    <title>@yield('title', 'Bina Desa - Sistem Surat Menyurat')</title>
    ...
    <div class="container-fluid nav-bar p-0">
        <nav class="navbar navbar-expand-lg navbar-light bg-white px-4 px-lg-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <a href="" class="btn btn-primary border-secondary rounded-pill py-2 px-4 px-lg-3 mb-3 mb-md-3 mb-lg-0">Pengajuan Surat</a>
            </div>
        </nav>
    </div>
    <!-- Navbar End -->
            ...
            <div class="row g-5">
                ...
                <div class="col-md-6 col-lg-6 col-xl-3">
                    <div class="footer-item d-flex flex-column">
                        ...
                        <a href="#" class="text-white mb-2"><i class="fas fa-angle-right me-2"></i> Surat Keterangan Domisili</a>
                        <a href="#" class="text-white mb-2"><i class="fas fa-angle-right me-2"></i> Surat Keterangan Tidak Mampu</a>
                        <a href="#" class="text-white mb-2"><i class="fas fa-angle-right me-2"></i> Surat Keterangan Usaha</a>
                        <a href="#" class="text-white mb-2"><i class="fas fa-angle-right me-2"></i> Surat Pengantar</a>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6 col-xl-3">
                    <div class="footer-item">
                        <h4 class="text-light mb-4">Informasi</h4>
                        <p class="text-white mb-3">Dapatkan informasi terbaru tentang layanan surat menyurat di desa kami.</p>
                    </div>
                </div>
            </div>
        </div>
