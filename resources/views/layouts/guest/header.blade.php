            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="contact.html" class="nav-item nav-link {{ request()->is('contact') ? 'active' : '' }}"><i class="fas fa-address-book me-1"></i>Kontak</a>
                        <a href="{{ route('user.index') }}" class="nav-item nav-link {{ request()->routeIs('user.index') ? 'active' : '' }}"><i class="fas fa-user-cog me-1"></i>Data User</a>
