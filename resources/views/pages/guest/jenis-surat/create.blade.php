                    ...
                    <div class="card form-card animate__animated animate__fadeInUp">
                        <div class="form-header text-center">
                            <div class="form-icon-wrapper">
                                <i class="fas fa-file-alt form-main-icon"></i>
                            </div>
                            <h3 class="mb-0">
                                Formulir Jenis Surat Baru
                            </h3>
                            <p class="text-muted mt-2">Isi informasi detail tentang jenis surat baru</p>
                        </div>
                        <div class="form-body">
                            <form method="POST" action="{{ route('jenis-surat.store') }}" id="jenisSuratForm">
                                @csrf
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <p class="card-text mb-0 small">
                                        Pastikan kode surat unik dan mudah diingat. Gunakan nama yang jelas dan deskriptif
                                        untuk memudahkan identifikasi jenis surat.
                                    </p>
                                </div>
                            </div>
                        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Trigger input event untuk menampilkan preview jika ada data old
