...
@section('content')
    ...
    <style>
        ...
        /* Gradient Badges */
        .bg-success-gradient { background: linear-gradient(to right, #28a745, #20c997); }
        .bg-danger-gradient { background: linear-gradient(to right, #dc3545, #f86c6b); }
        .bg-warning-gradient { background: linear-gradient(to right, #ffc107, #ffca2c); color: #333 !important; }
        .bg-info-gradient { background: linear-gradient(to right, #17a2b8, #3abaf4); }
        .bg-secondary-gradient { background: linear-gradient(to right, #6c757d, #adb5bd); }
