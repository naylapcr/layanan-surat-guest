    ...
    <!-- Content Start -->
     <div class="page-header">
        <div class="container text-center">
            ...
            <p class="lead text-white animate__animated animate__fadeInUp">Ajukan permohonan surat baru untuk keperluan administrasi</p>
        </div>
    </div>
                            ...
                            <form method="POST" action="{{ route('permohonan-surat.store') }}" id="permohonanSuratForm">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group-icon">
                                            <select name="status" id="status" class="form-control input-focus-effect @error('status') is-invalid @enderror" required>
