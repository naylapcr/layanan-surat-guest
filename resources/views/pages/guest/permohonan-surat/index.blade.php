                ...
                <div class="col-md-3 mb-4">
                    <div class="card card-stat bg-success text-white shadow h-100 stats-card" data-aos="fade-up"
                        ...
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div>
                                <h4 class="mb-0 counter"
                                    data-target="{{ $permohonan->where('status', 'SELESAI')->count() }}">0</h4>
                                <p class="mb-0">Selesai (Page Ini)</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 mb-4">
                    <div class="card card-stat bg-info text-white shadow h-100 stats-card" data-aos="fade-up"
                        ...
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div>
                                <h4 class="mb-0 counter"
                                    data-target="{{ $permohonan->unique('jenis_surat_id')->count() }}">0</h4>
                        ...
                        <div class="search-box me-3 flex-grow-1">
                            <div class="input-group search-container">
                                <input type="text" class="form-control border-0 input-focus-effect"
                                    placeholder="Cari nomor permohonan atau nama pemohon..." name="search"
                        ...
                        <div class="dropdown me-3">
                            <div class="dropdown">
                                <button class="btn btn-outline-secondary dropdown-toggle filter-btn" type="button"
                                    data-bs-toggle="dropdown" data-bs-toggle="tooltip" title="Filter Status">
            ...
            <div class="row" id="permohonanContainer">
                ...
                @forelse($permohonan as $index => $item)
                    <div class="col-xl-4 col-md-6 mb-4 permohonan-card animate__animated animate__fadeInUp"
                        ...
                        data-search="{{ strtolower($item->nomor_permohonan . ' ' . ($item->warga ? $item->warga->nama : 'Tidak Diketahui')) }}"
                        data-aos="fade-up" data-aos-delay="{{ ($index % 3) * 100 }}">
                        <div class="card widget-card h-100">
                            <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                                <h6 class="mb-0">
                                    <i class="fas fa-envelope me-2"></i>{{ $item->nomor_permohonan }}
                                </h6>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ route('permohonan-surat.show', $item->permohonan_id) }}">
                                                <i class="fas fa-eye me-2"></i>Detail
                                            </a>
                                        </li>

                                        @if (Auth::check() && (Auth::user()->role == 'super_admin' || Auth::user()->role == 'staff'))
                                            <li>
                                                <a class="dropdown-item"
                                                    href="{{ route('permohonan-surat.edit', $item->permohonan_id) }}">
                                                    <i class="fas fa-edit me-2"></i>Edit
                                                </a>
                                            </li>
                                            <li>
                                                <button type="button" class="dropdown-item text-danger delete-btn"
                                                    data-permohonan-id="{{ $item->permohonan_id }}"
                                                    data-permohonan-name="{{ $item->nomor_permohonan }}">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <p class="mb-2">
                                            @if ($item->jenisSurat)
                                                <i class="fas fa-file-alt me-2"></i>{{ $item->jenisSurat->nama_jenis }}
                                            @else
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <p class="mb-2"><i
                                                class="fas fa-calendar text-warning me-2"></i>{{ \Carbon\Carbon::parse($item->tanggal_pengajuan)->format('d M Y') }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    @else
                                        ...
                                        <div class="col-6">
                                            <a href="{{ route('permohonan-surat.edit', $item->permohonan_id) }}"
                                                class="text-secondary edit-link" title="Edit"
                                                data-bs-toggle="tooltip">
                ...
                <div class="row mt-4">
                    <div class="col-12 text-center">
                        <p class="text-muted" id="dataInfo">
                            <i class="fas fa-info-circle me-2"></i>Menampilkan {{ $permohonan->count() }}
                            dari {{ $permohonan->total() }} permohonan surat
                        </p>
                    </div>
                </div>
            @endif
                        ...
                        <nav aria-label="Page navigation">
                            <ul class="pagination justify-content-center">
                                ...
                                @else
                                    <li class="page-item">
                                        <a class="page-link"
                                            href="{{ $permohonan->previousPageUrl() }}{{ request()->getQueryString() ? '&' . http_build_query(request()->except('page')) : '' }}"
                                            rel="prev">«</a>
                                    </li>
                                @endif
                                ...
                                @if ($permohonan->hasMorePages())
                                    <li class="page-item">
                                        <a class="page-link"
                                            href="{{ $permohonan->nextPageUrl() }}{{ request()->getQueryString() ? '&' . http_build_query(request()->except('page')) : '' }}"
                                            rel="next">»</a>
                                    </li>
                                @else
                                    <li class="page-item disabled">
