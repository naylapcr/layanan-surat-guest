                            ...
                            <form method="POST" action="{{ route('permohonan-surat.update', $permohonan->permohonan_id) }}"
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group-icon">
                                            <select class="form-select input-focus-effect" id="warga_id" name="warga_id"
                                                required>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-12">
                                        ...
                                        <div class="mb-3">
                                            <div class="alert alert-info">
                                                ...
                                                <a href="{{ route('permohonan-surat.show', $permohonan->permohonan_id) }}"
                                                    class="fw-bold text-decoration-underline">Klik di sini untuk ke halaman
                                                    Detail</a>.
                                            </div>
                                        </div>
                                        ...
                                        <small class="text-muted d-block mt-1">
                                            * File yang diupload di sini akan <strong>ditambahkan</strong> ke daftar file
                                            yang sudah ada
                                        </small>
