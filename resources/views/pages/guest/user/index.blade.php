    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            ...
            <div class="row mb-5">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card card-stat bg-info text-white shadow h-100 stats-card" data-aos="fade-up" data-aos-delay="300">
                        <div class="card-body text-center">
                            <div class="stats-number counter" data-target="{{ $users->where('created_at', '>=', now()->subDays(7))->count() }}">0</div>
                            <div class="stats-label">
            ...
            <div class="row" id="userContainer">
                ...
                <div class="col-xl-4 col-md-6 mb-4 user-card-item animate__animated animate__fadeInUp" data-name="{{ strtolower($user->name) }}" data-email="{{ strtolower($user->email) }}" data-recent="{{ $user->created_at->gte(now()->subDays(7)) ? 'recent' : 'old' }}" data-aos="fade-up" data-aos-delay="{{ ($index % 3) * 100 }}">
                        ...
                        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li>
                                        <button type="button" class="dropdown-item text-danger delete-btn" data-user-id="{{ $user->id }}" data-user-name="{{ $user->name }}">
                        ...
                        <div class="card-body">
                            <div class="user-info-list">
                                ...
                                <div class="user-info-item d-flex justify-content-between align-items-center">
                                    ...
                                    <strong class="text-end text-truncate" style="max-width: 150px;">{{ $user->email }}</strong>
                                </div>
                                ...
                                <div class="user-info-item">
                                    ...
                                    <div class="input-group password-input-group">
                                        <input type="password"
                                               ...
                                               readonly
                                               id="password-{{ $user->id }}">
                                        <button class="btn btn-outline-secondary btn-sm password-toggle" type="button" onclick="togglePassword({{ $user->id }})" data-bs-toggle="tooltip" title="Tampilkan/Sembunyikan">
                                            <i class="fas fa-eye" id="eye-icon-{{ $user->id }}"></i>
                                        </button>
                                        <button class="btn btn-outline-info btn-sm copy-btn" type="button" onclick="copyPassword({{ $user->id }})" data-bs-toggle="tooltip" title="Salin hash password">
                        ...
                        <div class="card-footer bg-light">
                            <div class="row text-center">
                                <div class="col-4 border-end">
                                    <a href="{{ route('user.show', $user->id) }}" class="text-secondary action-link" title="Lihat Detail" data-bs-toggle="tooltip">
                                        <i class="fas fa-eye"></i>
                                        <small class="d-block mt-1">Detail</small>
                                    </a>
                                </div>
                                <div class="col-4 border-end">
                                    <a href="{{ route('user.edit', $user->id) }}" class="text-secondary action-link" title="Edit User" data-bs-toggle="tooltip">
                                        <i class="fas fa-edit"></i>
                                        <small class="d-block mt-1">Edit</small>
                                    </a>
                                </div>
                                <div class="col-4">
                                    <button type="button" class="btn btn-link text-danger p-0 delete-footer-btn" data-user-id="{{ $user->id }}" data-user-name="{{ $user->name }}" title="Hapus User" data-bs-toggle="tooltip">
