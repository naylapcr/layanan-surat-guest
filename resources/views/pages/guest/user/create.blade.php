...
@section('content')
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group-icon">
                                            <select name="role" id="role"
                                                class="form-select input-focus-effect @error('role') is-invalid @enderror"
                                                required>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <p class="card-text mb-0 small">
                                        Pastikan email yang dimasukkan aktif. Gunakan password yang kuat (minimal 8
                                        karakter, kombinasi huruf dan angka) untuk keamanan akun.
                                    </p>
                                </div>
                            </div>
                        </div>
    ...
    <style>
        ...
        .password-toggle-icon {
            position: absolute;
            right: 40px;
            /* Geser sedikit agar tidak menumpuk dengan icon lock */
            top: 50%;
            transform: translateY(-50%);
            color: #6c757d;
            cursor: pointer;
