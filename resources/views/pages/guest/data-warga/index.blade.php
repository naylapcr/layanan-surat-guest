    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            ...
            <div class="row mb-5">
                ...
                <div class="col-md-3 mb-4">
                    <div class="card card-stat bg-success text-white shadow h-100 stats-card" data-aos="fade-up" data-aos-delay="200">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div>
                                <h4 class="mb-0 counter" data-target="{{ $warga->where('jenis_kelamin', 'L')->count() }}">0</h4>
                ...
                <div class="col-md-3 mb-4">
                    <div class="card card-stat bg-info text-white shadow h-100 stats-card" data-aos="fade-up" data-aos-delay="300">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div>
                                <h4 class="mb-0 counter" data-target="{{ $warga->where('jenis_kelamin', 'P')->count() }}">0</h4>
                ...
                <div class="col-md-3 mb-4">
                    <div class="card card-stat bg-warning text-white shadow h-100 stats-card" data-aos="fade-up" data-aos-delay="400">
                        <div class="card-body d-flex align-items-center">
                            <div class="me-3">
                                <i class="fas fa-briefcase fa-3x"></i>
                            </div>
                            <div>
                                <h4 class="mb-0 counter" data-target="{{ $warga->pluck('pekerjaan')->unique()->count() }}">0</h4>
            ...
            <div class="row mb-4">
                    ...
                    <div class="d-flex">
                        <div class="search-box me-3 flex-grow-1">
                            <div class="input-group search-container">
                                <input type="text" class="form-control border-0 input-focus-effect" placeholder="Cari warga..." id="searchInput">
                        ...
                        <div class="dropdown">
                            <button class="btn btn-outline-secondary dropdown-toggle filter-btn" type="button" data-bs-toggle="dropdown" data-bs-toggle="tooltip" title="Filter data warga">
                ...
                <div class="col-md-4 text-md-end">
                    <a href="{{ route('warga.create') }}" class="btn btn-primary floating-action-btn" data-bs-toggle="tooltip" title="Tambah data warga baru">
            ...
            <div class="row" id="wargaContainer">
                ...
                <div class="col-xl-4 col-md-6 mb-4 warga-card animate__animated animate__fadeInUp" data-gender="{{ $data->jenis_kelamin }}" data-name="{{ strtolower($data->nama) }}" data-aos="fade-up" data-aos-delay="{{ ($index % 3) * 100 }}">
                        ...
                        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li>
                                        <button type="button" class="dropdown-item text-danger delete-btn" data-warga-id="{{ $data->warga_id }}" data-warga-name="{{ $data->nama }}">
                                ...
                                <div class="col-6">
                                    ...
                                    <p class="mb-2">
                                        @if($data->jenis_kelamin == 'L')
                                            <span class="badge gender-badge bg-primary"><i class="fas fa-male me-1"></i>Laki-laki</span>
                                        @else
                                            <span class="badge gender-badge bg-pink"><i class="fas fa-female me-1"></i>Perempuan</span>
                                        @endif
                                    </p>
                                </div>
                                <div class="col-6">
                        ...
                        <div class="card-footer bg-light">
                            <div class="row text-center">
                                <div class="col-6 border-end">
                                    <a href="tel:{{ $data->telp }}" class="text-secondary contact-link" title="Telepon" data-bs-toggle="tooltip">
                                        <i class="fas fa-phone-alt"></i>
                                        <small class="d-block mt-1">Telepon</small>
                                    </a>
                                </div>
                                <div class="col-6">
                                    <a href="mailto:{{ $data->email }}" class="text-secondary contact-link" title="Email" data-bs-toggle="tooltip">
            ...
            <div class="row mt-4">
                <div class="col-12 text-center">
                    <p class="text-muted" id="dataInfo">
                        <i class="fas fa-info-circle me-2"></i>Menampilkan <span id="filtered-count">{{ $warga->count() }}</span> data warga
                    </p>
                </div>
            </div>
        </div>
